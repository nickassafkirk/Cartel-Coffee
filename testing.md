...
### User stories
#### i. As a new user I want to see the menu and phone number so I can order food for collection.    
...
#### ii. As a new user I want to fill out a contact form so that I can make a reservation for dinner.      
...
#### iii. As a new user I want to view the business's product range and contact details so I can order products remotely.   
   ...
   **To Test:** A new user landing on the site homepage can access the shop page from the clearly labelled shop heading in the main navbar. A user can navigate to specific product categories via the clearly labelled product category tiles on the site homepage. 
    ...
    As directed by the modal the customer must call to place an order. The company's phone number is retrievable in the footer accessible from all site pages or clearly labelled on the contact page, accessible from the main navbar.
    
   **Result:** The site features and functionality satisfy the needs outlined in the user story. The ability to checkout and order online would increase conversion and ease of use for the customer but adding this functionality was not achievable within the scope of this project.

#### iv. As a new user I want to view a gallery of the Cafe and their social media, so I that can decide if it is an appropriate environment to hold a business meeting.   
   ...
   **Result:** The site features satisfy the needs outlined in the user story. Improvements could be made by adding a dedicated gallery page to the site or by adding an instagram feed embed. These additional features will be considered for future development phases of this project.

#### v. As a potential customer I want to see the Cafe's location on a map, so I know where to find the business.    
   ...
   **To Test:** A new customer landing on the homepage can access the company's address by navigating to the contact page, which is clearly labelled in the main navbar. A user can get the business's location in the footer which is accessible from every site page. 
    ...
    Clicking the map pin will open google maps in a new tab where the user can get directions to visit the cafe. Clicking the map iframe on mobile will open the google maps application, where navigation directions are included as an option. 
    
   **Result:** The site features satisfy the needs outlined in the user story.

#### vi. As a potential customer I want to know when the business is open so I can visit the business.    
    
   **To Test:** A new user landing on any page can access the contact page from the main navigation menu. A user can also visit the contact page by clicking the "find us" footer link or "contact us" footer heading.
...
#### vii. As a new user I need to be able to navigate between site pages so I can view multiple site pages.    
...
#### viii. As a new user I want to trust the business and value their products, to ensure I am spending my money wisely.   
    
   **To Test:**  From the  homepage a user can view the business's about information which qualifies the business. The address and contact details in the footer show that the business has a physical location and can be contacted which adds user trust. The about page, Terms and conditions and privacy policy 
    show that the business has a professional approach. By navigating to the shop page a user can see the product range offered by the business. Descriptive images, clear titles and prices display the products quality and value. Trust marks in each product section 
...
#### ix. As a potential customer I need to know if the business is wheelchair accessible so I can decide if the business is suitable for people with disabilities.    
   ...
   **To Test:** A new user can access the business's contact details from the footer of every page. A user can contact the business by phone or email to enquire if the business premises is wheelchair accessible.
    Alternatively a user can access the contact page from the navbar or footer on any page on the site. Once on the contact page a user can make an enquiry or call the business via the contact form or phone number. Alternatively a user can scroll to the FAQ section
    where the first FAQ heading is regarding wheelchair accessibility. A user may also access the FAQs section via the link in the footer which is accessible from every page. 
...
### 1: Navbar 
* **Aim:** The Navbar is expected to be located full-width at the top of all pages. The navbar logo and links should scale to promote readability on larger/smaller screen widths and 
to avoid overflow. The Navbar should expand/collapse at set breakpoint.    
* **Test:** The browser window was expanded and collapsed to ensure that the navbar occupies the full screen width on all viewport sizes and to ensure that the navbar expands and collapses at the correct breakpoint. I visually confirmed that header fonts scale to avoid overflow on different screensizes and 
to improve readability on all devices. 
* **Result:** Navbar functions as intended across all screen sizes. 
 ...
 * **Test:** I verified that the navbar links point to the correct page on all site pages and that the correct active class is displayed for each page.     
 ...
 * **Test:** I hovered the cursor over each navbar link and observed the result.                 
 * **Result:** I verified that the navbar link hover functionality highlights navbar menu items as intended.
 ...
 * **Test:** Visit each site page and ensure correct menu item is higlighted when on it's corresponding page.   
 ...
 * **Test:** I clicked the burger stack icon on all pages and on touch and cursor devices. I Expanded and minimized the viewport to test the collapse functionality.       
 * **Result:** I Verified that the burger stack functions as anticipated on click, that the navbar expands/collapses at the correct breakpoint and that navbar items are aligned to right as desired.     
 
### Footer

* **Aim:** The footer should occupy 100% screen width across all screen sizes and be present at the bottom of the page below all other content at all times.
 The footer columns should re-shuffle at 768px breakpoint to ensure proper display on smaller screen widths. 
* **Test:** I checked the footer presence on all pages. I checked that footer the columns re-order at the correct breakpoint by expanding/minimizing viewport and testing on tablet and mobile devices.  
* **Result:** The footer is present in the correct position on all pages and scales correctly for good responsive design. 
 ...
 * **Result:** Footer links direct to the correct destination and format as intended on all pages.
 ...
 ### Social media links
 * **Aim:** The social media links are intended to open a new tab or window linking to the instagram, facebook and twitters homepages respectively.
...
### Covid-19 Alert
* **Aim:** The Covid-19 alert banner should appear abover the navbar at the top of each page, excluding the about and submit pages. The alert should take up the full screen width.
...
Users should be able to close the alert using it's "(x)close icon" in the top right hand corner.    
* **Test:** To test this I visited each site page and observed that the alert was present and occupies the full screen-width of each page. I visited the about and submit pages to confirm that the alert is not present on these pages.
...
## [Homepage](https://nickassafkirk.github.io/Cartel-Coffee/)

### Image Carousel: 
* **Aim:** The Image carousel should appear directly below the navbar at the top of the index.html page. The carousel should span the full screen width. The carousel should display vertically and horizontally centered
...
* **Test:** To test I visited the homepage on all browsers, mobile and tablet devices and observed the carousel. I used a responsive browser window to test that the banner changes image at the correct breakpoint. I Clicked the slide control buttons and observe that they toggle to the next slide upon click. 
I observed the captions to ensure their position remains centered on the slide and scales to fit each slide image when the viewport size is changed. I confirmed that there are 3 carousel slides.
* **Result:** I confirmed that the carousel has desired styles and behaviour, is positioned correctly, scales to fit multiple viewport sizes and has working slide control buttons. 
 ...
 ### Welcome section: 
 * **Aim:** On desktop it is intended that the full welcome paragraph is revealed. On mobile the paragraph becomes a - (minus) icon which will collapse the welcome paragraph on click. When the welcome paragraph is hidden the - (minus) symbol is replased with a + (plus) symbol which expands the welcome paragraph.
 * **Test:** To test this I viewed the homepage on multiple screen widths and devices and verified visually that the - icon and collapsed paragraph are not displayed on screen widths greater than 576px. I also verified that the welcome text is 
 ...
 * **Test:** To test that the menu category tiles were operating as intended I viewed this section on multiple devices and with a responsive browser window and ensured there was no overflow or alignment issues on any screenwidths. 
 I clicked each image to test that the image tiles are working and each link directs to the correct section ID on the menu page. I tested hover functionality by hovering the cursor over each tile and ensured that hovering the cursor over the image highlights the image and hides it's overlying text.  
 * **Result:** The homepage menu category tiles function and format as intended.

### Shop popular category tile section:
* **Aim:** The entire shop image tiles should be clickable links to a corresponding shop.html section. Image tiles should display responsive design to reorder at the correct breakpoint. The overlaying headings and imitation-buttons should scale correctly on all screenwidths. 
Tiles be highlighted upon hover and the "button" should change it's background color on hover to encourage click behaviour.     
* **Test:** To test that the shop category tiles were operating as intended I viewed this section on multiple devices and with a responsive browser window. I ensured there was no overflow or alignment issues on any screen widths. 
 I also tested that the image tiles are working and that each link directs to the correct section ID on the shop page. I tested the hover functionality by hovering the cursor over each tile and confirming the hover behaviour functions as intended across browsers. 
...
* **Note:** On opera footer links linking to specific section ID's on a different page will sporadically direct to the top of the page rather than scrolling to the correct page section. This is outlined fully in the bugs section.

### About Section:
* **Aim:** The about section should display as three short paragraphs on small screen widths or larger. On  Xs screen widths, the about section should only display the first line of text followed by a link which says "read more". The read more link is expected to expand the full about paragraph when clicked. Once opened a "Read less" link will appear at the bottom of the about text. 
Clicking the "read less" link will hide the main body of about text.
 * **Test:** To test this I viewed the homepage on multiple screen widths and devices and verified visually that the full about paragraph is displayed on screen widths greater than 576px. To test the mobile functionality of this section I ensured that clicking the "read more" link expands the full about text section. 
...
* **Test:** To test I viewed the menu.html page and confirmed that the background image occupies the full background between the navbar and footer on all devices and viewport sizes. I confirmed that the background image shows a relevant image and
...
* **Result:** The body background formats as intended.

### Intro Section
* **Aim:** Intro text is added to provide page context and encourage users to learn what the page is about. 
It needs to scale to fit the viewport size and to have adequate contrast between text and background colors to aid readability. 
...
The section has sufficient contrast between background and text to easily read the intro text. 
...
### Dessert Menu
* **Aim:** The Dessert menu should have 3 sections: pastries, favourites, and a specials notice. The first 2 columns should be displayed as a 2x1 grid on larger screen widths and as 2 vertically stacked columns on smaller screen widths. The favourites `<h4>` heading has been styled
to disappear when the bootstrap columns stack vertically to give the impression that it's a single dessert section. 
The specials notification should display as a thin full width column below on all screen sizes.
* **Test:** The menu page was viewed on multiple devices and screen widths to confirm that the text content is displayed clearly and legibly across all screen sizes.
...
### Coffee Menu
* **Aim:** The coffee menu should have 4 sections: a coffee title column, a coffee size column, a coffee price column and an alternative milk notice. The first 3 columns should be displayed as a 3x1 grid on larger screen widths. On smaller screen widths the coffee size column is removed to create a 2x1 grid.
...
The links should be styled to look like buttons. The "buttons" should be of equal proportions. When clicked the phone "button" should automatically open the number as a call on mobile devices. 
The deliveroo link should link to deliveroo's homepage in a new tab or window when clicked.
...
### Shop Modal
* **Aim:** The shop modal should appear upon loading of shop.html page. The modal should scroll to center on the viewport if a shop section ID is referenced from the footer links or homepage shop tiles.
...
* **Note:** For future updates of this project, it is my intention to use cookie settings to ensure that this modal is only opened the first time a user
...
### Section Headings
* **Aim:** Section headings should span the same screen width as the product tiles and jumbotrons. The product section headings should have visible background images which change aspect-ration on smaller screen sizes.
...
By viewing the shop page on a responsive browser window, tablet and mobile devices I confirmed that the section headings behave responsively to occupy the same screen width as the product tiles and jumbotrons.    
* **Result:** I confirmed that the shop page section headings are styled as intended.
...
### Staff Favourite Banner
* **Aim:** The staff favourite banner should be located in the top left of the image of selected products. The Staff favourite banner should be clearly readable. 
The staff favourite banner should have an expand effect on click or hover.
* **Test:** To test I viewed the shop page on multiple devices and viewport sizes. I confirmed that the staff favourite banner was aligned correctly to the product images. I visually confirmed that the banner was present for the correct products. By clicking and hovering the cursor over the banner
I observed that the banner grew larger on the x and y axis. By testing on mobile I confirmed that this expand effect also works as intended on touch screen devices.
* **Result:** The staff favourites banners function as intended.
...
## [Contact Page](https://nickassafkirk.github.io/Cartel-Coffee/contact.html)
...
The page contains 4 distinct sections; find us, contact us, make a booking and FAQs. This should display as a 2 x 2 grid layout on larger screen sizes and as 4 vertically stacked sections on medium screen widths and under.
...
### Find Us
* **Aim:** `<iframe>` element should show map of the companies location. The opening hours, address, email and phone columns should display as 2x2 grid on wider screen widths and as 3 full width vertically stacked columns on smaller screen widths. The "email" and "phone" headings should be hidden on smaller screen widths and replaced with a "contact us" column which contains the phone and email.
* **Test:** I Viewed the contact page on large screen widths and observed the find us section behaviour. The Iframe displays correctly and is responsive for different viewport sizes. Clicking the iframe on mobile devices opens google maps, where directions to the location are provided as an option. Clicking the iframe on desktop allows the user to move around the map. Clicking on the location flag on desktop opens the location information in google maps.
The address, hours, phone and email sections are clearly legible and reorder at the correct breakpoint when the screen size is adjusted. 
...
* **Test:** To test I first clicked the form submission button without filling out any fields. The validation error messages were displayed for each required field as intended. The form was not submitted with missing fields as intended.
...
* **Result:** After initial broken links were corrected, The contact us section works as intended.  

### Make A Booking
* **Aim:** This section contains a dedicated booking form. The form has a first name input, last name input, email input, phone input, a textarea for a user message, as well as a date field, a "number of guests" `<select>` and a submission button. 
The form should provide validation advice if required fields are left blank. The form should prevent form submission if required inputs are not filled out. Upon successful validation and submission, the page should reload on the ["submit.html" page](submit.html).
...
The "make a booking" form now operates as anticipated. 

### FAQs
* **Aim:** FAQs boxes should be of equal width. The FAQ container should align vertically with the make a booking container on large screen sizes. The FAQ headings should have a primary button background color on hover. Clicking each FAQ heading should expand it's associated FAQ card. 
...
* **Test:** I viewed the FAQ section in a responsive browser window and on multiple devices and observed that all FAQ headinsg were of equal width. I observed that the FAQ container aligns vertically with the make a booking section container. 
I observed that the FAQ headings have a highlighted backround color (`--custom`) when hovered over with the cursor.  I clicked each FAQ heading and confirmed that it's associated card was openend on click. I clicked each FAQ heading when it's card was displayed and confirmed that the card was then collapsed. 
I clicked each other FAQ header while a different card was open and observed that this opened the card of the clicked heading and closed any other open FAQ cards. 
...
### Return Home Button
* **Aim:** The return home button should link to the homepage.
...
## [submit.html](https://nickassafkirk.github.io/Cartel-Coffee/submit.html)
...
### Return Home Button
* **Aim:** The return home button is expected to link back to the site homepage.
* **Test:** To test I clicked the return home button and observed it's behaviour. 
* **Result:** The return home button links to the site homepage as intended.
...
During the development and testing phases of this project a number of bugs were identified. A detailed 
description of the main bugs experienced can be seen below. 

Where code used to fix bugs was found in forums or from other developers, additional information has
...
* **Bug:** Navbar toggle burger stack stacking vertically on XS screensizes. 
  **Fix:** Added media query to navbar-brand so that the font-size is decreased on XS devices. This left ample room for the burger stack icon and prevents vertical stacking of header items on XS devices.

* **Bug:** Undesired Indent in top right of Navbar and footer.
  **Fix:** I added a viewport width value of 100 to ensure that the navbar occupies the full width of the screen across all screen sizes. Media queries were utilised to adjust the font-size of the logo and navbar items on different screen-widths
  to ensure that content overflow did not create a similar issue.

  ![Right indent bug](assets/images/bugs/right_indent_bug.png)

* **Bug:** Carousel images not scaling correctly when changing screensizes. Images were cropped unevenly in responsive browser windows.
  **Fix:** A main image with a portrait aspect-ratio is used on smaller screensizes on the assumption that smaller devices primarily utilise viewports more suited to portrait aspect images. An Alternative image with a landscape aspect-ratio has been added for larger screen-widths on the assumption that laptops, desktops and larger screens utilise a landscape aspect ratio ordinarily. I decided this was a better tactic than using the object-fit property because it ensures
...
* **Bug:** Labels for tiles not scaling correctly when changing screensizes. On smaller screensizes the label headings were moving off their desired position in the center of the image tiles.
  **Fix:** I used position: relative and top and bottom percentage values to fix the headings to the image tiles regardless of screen size. Media queries are used to edit the font size to ensure, overflow does not cause 
  undesireable rendering on smaller viewports and devices.

* **Bug:** Category headings overflow their housing containers on tablet due to excessive font-size at the 768px breakpoint. 
...
* **Bug:** Button placement on shop category homepage tiles not positioning correctly on mobile on IOS.  
  **Fix:** I Used `position: absolute;`, `top: 50%;` to position the button relative to it's containing parent on all screen sizes and ensure proper formatting of this section.

* **Bug:** The footer `<li>` items were indented from the left and were overflowing their housing containers.   
  **Fix:** I removed the default left padding on the `<ul>` element to ensure desired content spacing for footer list items. 
...
* **Bug:** The modal on the shop page was fixed to the top of the page. When using the footer navigation links to navigate to popular shop category (coffee, subscriptions, equipment and merchandise) anchor links, the user would be scrolled down the page.
  However the modal remained fixed to the top of the page out of the view. This meant that users could not close the modal or interact with the shop page.    
  **Fix:** Using fixed positioning, percentage top and left values and the transform property, I was able to ensure that the modal is positioned in the center of the screen even when the screen is scrolled to target an anchor link.
...
* **Bug:** The make a booking form initially assigned the first `<select>` option as the default value entered. This provided a poor user experience as users could easily submit the form without 
selecting the correct number attendees for their booking. 
...
This enforces that users must choose a valid `<select>` `<option>` from 1 guest to >6 guests and ensures that the form is not submitted incorrectly and provides a better overall user experience.

---

### Remaining Bugs To Be Fixed

* **Bug:** Anchor links sporadically not pointing to correct page section on Opera browser: When trying to navigate to a specific anchor link from the page footer using opera, the link occasionally loads at the top of targeted page, instead of to the correct page section targeted using the the ID anchor link.
...
This behaviour doesn't occur every time or predictably, nor does it affect any other browser tested. Therefore this bug is believed to be a browser specific bug. While this bug is not ideal it is not fatal as the links do transport the user to the desired page where by scrolling down the correct section can be viewed.
